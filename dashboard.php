...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#"><i class="fas fa-phone-alt"></i> Contact Us</a>
                    </li>
                    <li class="nav-item">
                        <a href="logout.php" class="btn btn-logout"><i class="fas fa-sign-out-alt"></i> Logout</a>
                    </li>
                    <li class="nav-item">
                        <a href="display.php" class="btn btn-primary"><i class="fas fa-database-alt"></i>Database Records</a>
                    </li>
                </ul>
            </div>
    ...
    <div class="container">
        <h2>Welcome to our <b>IIT System</b></h2>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="hacker.jpeg" class="d-block w-100" alt="Corporate Image">
                </div>
                <div class="carousel-item">
                    <img src="hacker1.jpeg" class="d-block w-100" alt="Office Meeting">
                </div>
                <div class="carousel-item">
                    <img src="hacker2.jpeg" class="d-block w-100" alt="Team Work">
                </div>
            </div>
